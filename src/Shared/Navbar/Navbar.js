...
const Navbar = () => {
  ...
  const menuItems = <React.Fragment>
    ...
    <span className=""><MdGroups className="mx-auto -mb-4 hidden lg:block text-white" /><li className="font-bold lg:text-white"><Link to='/'><MdGroups className="lg:hidden -mr-2" />About US</Link></li></span>
...

    {
      user?.uid ?
        <>
          ...
          {/* <li className="font-bold lg:text-white"><button onClick={handleSignout}>Sign Out</button></li> */}
        </>
        :
        <>
