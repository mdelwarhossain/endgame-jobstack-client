  ...
  return (
    <div className='my-5 py-10'>
      <div className="max-w-xs rounded-md shadow-md bg-gray-200 relative">
        <img src="https://source.unsplash.com/random/300x300/?2" alt="" className="object-cover object-center w-full rounded-t-md h-20 bg-gray-500" />
        <div className="flex flex-col justify-between p-6 space-y-8">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-900 text-md">Web Developer || Mern Stack Developer || Full Stack Developer || Back End Developer</p>
          </div>
          <hr />
