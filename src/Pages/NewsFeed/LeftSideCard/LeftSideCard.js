        ...
        <div className="flex flex-col justify-between p-6 space-y-8">
         {
          ...
          <div className="space-y-2 text-center">
            <Link to='/userProfile'><h2 className="text-2xl font-semibold tracking-wide">{currentUserDetails?.name}</h2></Link>
            <div>
              {
                currentUserDetails?.headline ? <p className="text-gray-900 text-md">{currentUserDetails?.headline}</p> :

                <p className="text-gray-900 text-md">Add A Headline</p>
              }
            </div>
          </div>
          <hr />
