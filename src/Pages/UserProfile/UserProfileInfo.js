        ...
        <div className="flex flex-col justify-between  space-y-8">
          ...
          <div className="shadow-lg p-6">
            <div className="space-y-2">
              ...
              <p className="text-md">
               {
                userDetails?.headline ? userDetails.headline : "Add a headline"
               }
              </p>
            </div>
            <hr className="mt-4" />
            ...
            <div className="flex justify-between">
              <div>
              {
                userDetails?.city|| userDetails?.country ? <p className="text-sm">
                <span>{userDetails.city}</span> <span>{userDetails.country}</span>
              </p> : 
          ...
          <div className="mt-6 flex justify-between shadow-lg p-6">
            ...
            <p>
              {userDetails?.university ? userDetails.university : "Add University"}
            </p>
            </div>
          ...
          <div className="mt-6 shadow-lg flex justify-between p-6">
            ...
            <p>
            {userDetails?.skills ? userDetails.skills : "Add Your Skills"}
            </p>
            </div>
