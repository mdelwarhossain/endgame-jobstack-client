...
const About = () => {
    return (
        <div style={{ backgroundImage: `url(${model})`, backgroundSize: "cover", backgroundPosition: 'center center', backgroundAttachment: 'fixed', height: '400px', }}>
            <div className='hero py-16 hero-overlay bg-opacity-50 text-center'>
                <div className='flex-col lg:flex-row'>
                    <h2 className='text-5xl text-white -mt-20 italic '>Details are the key for perfection</h2>
                    <p className='font-italic text-2xl text-white mt-10 italic '>We mix all detailed things together</p>
                </div>
            </div>
        </div>
