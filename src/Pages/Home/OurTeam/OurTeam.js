  ...
  return (
    <section className="py-6 bg-gray-100 overflow-hidden">
      <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
        <p className="p-2 text-2xl font-bold tracking-wider text-center uppercase">
          Our Developer team
        </p>
        <h1 className="text-4xl font-bold text-green-500 leading-none text-center sm:text-5xl mb-5">
        ...
        <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
          ...
          >
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a
                ...
                href="https://dancing-taffy-e6e9f6.netlify.app/"
                title="portfolio"
                target="_blank"
              ...
              <a
                rel="noopener noreferrer"
                href="https://github.com/mdelwarhossain"
                title="GitHub"
                target="_blank"
                className="text-gray-900"
              >
          ...
          >
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full "
              src={"https://i.ibb.co/H4tx8PT/tgv.jpg"}
            />
            <div className="flex-1 my-4">
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a
                rel="noopener noreferrer"
                href="https://portfolio-website-5ba7c.web.app/"
                title="portfolio"
                target="_blank"
                className="text-gray-900"
              >
          ...
          >
            <img
              ...
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full "
              src={
                "https://i.ibb.co/k3dthyY/322724240-690408489452938-3095260205616899648-n.jpg"
              }
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leading-snug">
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              ...
              <a
                rel="noopener noreferrer"
                href="https://github.com/SADIA-AFSANA"
                title="GitHub"
                target="_blank"
                className="text-gray-900"
              >
          ...
          >
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full "
              src={`https://i.ibb.co/0q8Myn7/Untitled-design-2.png`}
            />
            <div className="flex-1 my-4">
              <p className="text-xl font-semibold leading-snug">
                Maksudur Rahman
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a
                rel="noopener noreferrer"
                href="https://boisterous-heliotrope-17e2d1.netlify.app/"
                title="portfolio"
                target="_blank"
                className="text-gray-900"
              >
          ...
          >
            <img
              alt=""
              className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full "
              src={`https://i.ibb.co/n89MCYX/937545.jpg`}
            />
            <div className="flex-1 my-4">
            ...
            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
              <a
                rel="noopener noreferrer"
                href="https://deluxe-moxie-88f3fb.netlify.app/"
                title="portfolio"
                target="_blank"
                className="text-gray-900"
              >
              ...
              <a
                rel="noopener noreferrer"
                href="https://github.com/mdmohsin2"
                title="GitHub"
                target="_blank"
                className="text-gray-900"
              >
