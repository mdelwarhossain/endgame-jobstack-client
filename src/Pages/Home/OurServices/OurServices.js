    ...
    <div className="mb-32 mt-14">
      ...
      <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-20">
        <div>
          ...
          <p className="ml-2">
            Stay ahead of the game with Jobstack's personalized newsfeed. Get
            ...
            stay ahead with Jobstack's powerful newsfeed.
          </p>
        </div>
        <div>
          <div className="flex">
          ...
          <p className="ml-2">
            ...
            with Jobstack. Browse thousands of job listings from top companies
        ...
        <div>
          ...
          <p className="ml-2">
            Find the best talent for your team with Jobstack's powerful hiring
        ...
        <div>
          ...
          <p className="ml-2">
            Advance your skills and knowledge with Jobstack's comprehensive
            ...
            competitive job market. Empower your career with Jobstack's online
            courses.
          </p>
        </div>
        <div>
          ...
          <p className="ml-2">
            Test your skills and knowledge with Jobstack's engaging quizzes.
            ...
            career to the next level with Jobstack's quizzes.
          </p>
        </div>
        <div>
          <div className="flex">
          ...
          <p className="ml-2">
            ...
            individuals with Jobstack. Build meaningful relationships, share
